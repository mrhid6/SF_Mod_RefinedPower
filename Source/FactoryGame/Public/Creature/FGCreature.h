...
public:
	...
	FORCEINLINE void SetSpawner( class AFGCreatureSpawner* inSpawner ) { mOwningSpawner = inSpawner; }
	...
	FORCEINLINE void SetNeedsSpawnerAccessor(bool needsSpawner) { mNeedsSpawner = needsSpawner; }
	FORCEINLINE bool GetNeedsSpawnerAccessor() { return mNeedsSpawner; }
	FORCEINLINE FTimerHandle GetKillTimerAccessor() { return mKillOrphanHandle; }
private:
	UFUNCTION()
