...
void ARPDysonSphere::TransferBuildStageItem(UFGFactoryConnectionComponent* InputConnection, TSubclassOf< UFGItemDescriptor > InputItem, int InputItemIndex) {
...
void ARPDysonSphere::TransferRepairItem(UFGFactoryConnectionComponent* InputConnection, TSubclassOf< UFGItemDescriptor > InputItem, int InputItemIndex) {
