#include "URPGameWorldModule.h"

#include "Kismet/GameplayStatics.h"
#include "FGCharacterPlayer.h"
#include "Equipment/FGResourceScanner.h"

void URPGameWorldModule::loadNodes()
{
    ...
    if (FJsonSerializer::Deserialize(Reader, JsonObject))
    {
        ...
        if (JsonObject->HasField("WaterTurbineNodes"))
        {
			...
			TSharedPtr<FJsonObject> Nodes = JsonObject->GetObjectField("WaterTurbineNodes");
...
void URPGameWorldModule::loadWTNToArray(TArray<TSharedPtr<FJsonValue>> Rows, TArray<FVector>& arr)
{
    arr.Empty();
...
void URPGameWorldModule::FinishedSpawningNodes()
{
...
FString URPGameWorldModule::DumpPPSettings(FPostProcessSettings PPSettings)
{
...
void URPGameWorldModule::DumpUObject(UObject* object)
{
    UClass *cl = object->GetClass();
    	...
    	if (cl)
    	{
    		...
    		for (TFieldIterator<FBoolProperty> Property(cl); Property; ++Property)
    		{
    		...
    		for (TFieldIterator<FFloatProperty> Property(cl); Property; ++Property)
    		{
    			// "Converting" bool to string
    			FName const PropertyName = Property->GetFName();
    		...
    		for (TFieldIterator<FUInt32Property> Property(cl); Property; ++Property)
    		{
    			// "Converting" bool to string
    			FName const PropertyName = Property->GetFName();
    		...
    		for (TFieldIterator<FIntProperty> Property(cl); Property; ++Property)
    		{
    			// "Converting" bool to string
    			FName const PropertyName = Property->GetFName();
